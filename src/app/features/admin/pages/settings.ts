...
@Component({
  ...
  template: `
    ...
    <div class="admin-header">
      ...
      <p class="header-desc">Manage system visual configurations, font sizes, typefaces, layout densities, and brand skin colors.</p>
    </div>
    ...
    <div class="settings-wrap">
      ...
      <div class="settings-card" style="border: 2px solid var(--theme-primary); background: color-mix(in srgb, var(--theme-cream) 95%, var(--theme-primary) 2%);">
        ...
        <div class="preview-card">
          <span class="preview-tag">Admin Canvas Preview</span>
          <h3 class="preview-title">Q4 Sales Performance Overview</h3>
          
          <div style="display:grid;grid-template-columns: repeat(auto-fit, minmax(180px, 1fr));gap:1rem;margin-bottom:1rem;">
            <div style="background:color-mix(in srgb, var(--theme-dark) 2%, transparent);padding:0.75rem;border-radius:0.75rem;border:1px solid color-mix(in srgb, var(--theme-dark) 4%, transparent);">
              <span style="font-size:0.6rem;font-weight:700;text-transform:uppercase;color:var(--theme-dark-light);">Gross Revenue</span>
              <p style="font-size:1.125rem;font-weight:800;color:var(--theme-dark);margin:2px 0 0 0;">₹4,89,500</p>
            </div>
            <div style="background:color-mix(in srgb, var(--theme-dark) 2%, transparent);padding:0.75rem;border-radius:0.75rem;border:1px solid color-mix(in srgb, var(--theme-dark) 4%, transparent);">
              <span style="font-size:0.6rem;font-weight:700;text-transform:uppercase;color:var(--theme-dark-light);">Conversion Rate</span>
              <p style="font-size:1.125rem;font-weight:800;color:var(--theme-dark);margin:2px 0 0 0;">4.8%</p>
            </div>
          </div>

          <p class="preview-text">
            Sales conversions have reached record numbers since deploying custom aroma-lock packaging. 
            Customer retention stands steady at 98.4% across the Malabar and Idukki Green Cardamom catalogs.
          </p>
      ...
      <!-- General Theme Mode (White / Black) -->
      <div class="settings-card">
        <div class="card-header">
          ...
          <div>
            <h2 class="card-title">General Theme Mode</h2>
            <p class="card-desc">Switch between clean white light layout or premium black dark layout.</p>
          </div>
        </div>
        ...
        <div class="presets-grid">
          ...
          >
            <span class="preset-label">Light Mode</span>
            <span class="preset-sub">White Clean Layout</span>
          </button>
          <button 
            class="preset-btn" 
          ...
          >
            <span class="preset-label">Dark Mode</span>
            <span class="preset-sub">Black Premium Layout</span>
          </button>
        </div>
      </div>
