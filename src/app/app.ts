  ...
  template: `
    ...
    @if (!isAdminRoute()) {
      ...
      <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp"
        class="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] hover:bg-[#20BD5A] rounded-full flex items-center justify-center shadow-lg shadow-[#25D366]/30 transition-all duration-300 hover:scale-110 hover:-translate-y-1 active:scale-95">
...
export class App implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Seed Firestore if empty (runs once)
    this.seedService.seedAll().catch(console.error);
  }
}
